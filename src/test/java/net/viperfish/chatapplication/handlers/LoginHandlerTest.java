...
public class LoginHandlerTest {
    ...
    public void testLoginHandlerSuccess() throws InvalidKeyException, NoSuchAlgorithmException, SignatureException {
        ...
        LSRequest req = new LSRequest("sample", new HashMap<>(), new Date(), 1L, "challenge", socket);
        ...
        req = new LSRequest("sample", new HashMap<>(), new Date(), 1L, TestUtils.generateCredential(resp.getAdditional(), testKey.getPrivate()), socket);
        req.setSession(session);
    ...
    public void testLoginHandlerFail() throws InvalidKeyException, NoSuchAlgorithmException, SignatureException {
        ...
        WebSocket socket = new MockWebSocket();
        req = new LSRequest("noexist", new HashMap<>(), new Date(), 1L, "challenge", socket);
        ...
        req = new LSRequest("sample", new HashMap<>(), new Date(), 1L, "challenge", socket);
